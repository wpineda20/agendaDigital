            ...
            <ul class="nav-links pt-0">
                ...
                <li class="text-center pb-1">
                    <a href="{{ url('/home') }}" class="text-center">
                        <i class="material-icons md-18 mx-auto">event</i>
                    </a>
                    <a href="{{ url('/home') }}">
                        <p class="link mx-auto">Agenda</p>
                    </a>
                </li>
                <!-- Home -->
                ...
                <li>
                    <div class="icon-link pb-1">
                        ...
                        <p class="link" style="padding-left: 4px">Administración</p>
                    </div>
                    <ul class="sub-menu">
                        <li><a href="{{ url('/events') }}">Eventos</a></li>
                        <li><a href="{{ url('/zones') }}">Zonas</a></li>
                        <li><a href="{{ url('/places') }}">Lugares</a></li>
                        <li><a href="{{ url('/rooms') }}">Espacios</a></li>
